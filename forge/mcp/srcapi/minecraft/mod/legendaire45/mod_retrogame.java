...
import net.minecraft.client.renderer.entity.RenderPlayerAPI;
...
import mod.legendaire45.render.RenderSword;
...
{	
		...
		{	
			...
			RenderPlayerAPI.register("mod_retrogame", RenderSword.class);
			/**Enregistre le bloc**/
