package mod.legendaire45.entity;
...
public class EntityTeleportArrow extends Entity implements IProjectile
{
    ...
    public EntityTeleportArrow(World par1World, EntityLiving par2EntityLiving, EntityLiving par3EntityLiving, float par4, float par5)
    {
        super(par1World);
        this.renderDistanceWeight = 10.0D;
    ...
    public EntityTeleportArrow(World par1World, EntityLiving par2EntityLiving, float par3)
    {
        super(par1World);
        this.renderDistanceWeight = 10.0D;
        this.shootingEntity = par2EntityLiving;
     ...
     */
    public static DamageSource causeArrowDamage(EntityTeleportArrow entityTeleportArrow, Entity par1Entity)
    {
        return (new EntityDamageSourceIndirect("arrow", entityTeleportArrow, par1Entity)).setProjectile();
    }
    ...
    public void onUpdate()
    {
        ...
        else
        {
            ...
            if (var4 != null)
            {
                ...
                if (!this.worldObj.isRemote)
                {
                    if (joueur instanceof EntityPlayerMP)
                    {
                        EntityPlayerMP joueurmp = (EntityPlayerMP)joueur;

                        if (!joueurmp.playerNetServerHandler.connectionClosed && joueurmp.worldObj == this.worldObj)
                        {
                            joueur.setPositionAndUpdate(this.posX, this.posY, this.posZ);
                            joueur.fallDistance = 0.0F;
                            joueur.attackEntityFrom(DamageSource.fall, 5);
                        }
                    }
