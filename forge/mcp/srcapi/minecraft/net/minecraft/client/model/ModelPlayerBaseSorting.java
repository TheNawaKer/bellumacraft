...
public final class ModelPlayerBaseSorting
{
    ...
    private String[] beforeGetRandomBoxSuperiors = null;
    private String[] beforeGetRandomBoxInferiors = null;
    private String[] overrideGetRandomBoxSuperiors = null;
    private String[] overrideGetRandomBoxInferiors = null;
    private String[] afterGetRandomBoxSuperiors = null;
    private String[] afterGetRandomBoxInferiors = null;
    ...
    public String[] getBeforeGetRandomBoxSuperiors()
    {
        return this.beforeGetRandomBoxSuperiors;
    }

    public String[] getBeforeGetRandomBoxInferiors()
    {
        return this.beforeGetRandomBoxInferiors;
    }

    public String[] getOverrideGetRandomBoxSuperiors()
    {
        return this.overrideGetRandomBoxSuperiors;
    }

    public String[] getOverrideGetRandomBoxInferiors()
    {
        return this.overrideGetRandomBoxInferiors;
    }

    public String[] getAfterGetRandomBoxSuperiors()
    {
        return this.afterGetRandomBoxSuperiors;
    }

    public String[] getAfterGetRandomBoxInferiors()
    {
        return this.afterGetRandomBoxInferiors;
    }

    public void setBeforeGetRandomBoxSuperiors(String[] var1)
    {
        this.beforeGetRandomBoxSuperiors = var1;
    }

    public void setBeforeGetRandomBoxInferiors(String[] var1)
    {
        this.beforeGetRandomBoxInferiors = var1;
    }

    public void setOverrideGetRandomBoxSuperiors(String[] var1)
    {
        this.overrideGetRandomBoxSuperiors = var1;
    }

    public void setOverrideGetRandomBoxInferiors(String[] var1)
    {
        this.overrideGetRandomBoxInferiors = var1;
    }

    public void setAfterGetRandomBoxSuperiors(String[] var1)
    {
        this.afterGetRandomBoxSuperiors = var1;
    }

    public void setAfterGetRandomBoxInferiors(String[] var1)
    {
        this.afterGetRandomBoxInferiors = var1;
    }
