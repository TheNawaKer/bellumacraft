...
public abstract class ServerPlayerBase
{
    ...
    {
        ServerPlayerBase var2 = this.playerAPI.GetOverwrittenAddExhaustion(this);
    ...
    {
        ServerPlayerBase var2 = this.playerAPI.GetOverwrittenAddExperience(this);
    ...
    {
        ServerPlayerBase var2 = this.playerAPI.GetOverwrittenAddExperienceLevel(this);
    ...
    {
        ServerPlayerBase var7 = this.playerAPI.GetOverwrittenAddMovementStat(this);
    ...
    {
        ServerPlayerBase var6 = this.playerAPI.GetOverwrittenCanPlayerEdit(this);
        boolean var7;

        if (var6 == null)
        {
            var7 = this.player.localCanPlayerEdit(var1, var2, var3, var4, var5);
        }
        else if (var6 != this)
        {
    ...
    {
        ServerPlayerBase var4 = this.playerAPI.GetOverwrittenDisplayGUIWorkbench(this);
    ...
    {
        ServerPlayerBase var2 = this.playerAPI.GetOverwrittenDropOneItem(this);
        EntityItem var3;

        if (var2 == null)
        {
            var3 = this.player.localDropOneItem(var1);
        }
        else if (var2 != this)
        {
    ...
    {
        ServerPlayerBase var1 = this.playerAPI.GetOverwrittenGetMaxHealth(this);
        int var2;

        if (var1 == null)
        {
            var2 = this.player.localGetMaxHealth();
        }
        else if (var1 != this)
        {
            var2 = var1.getMaxHealth();
        }
        else
        {
            var2 = 0;
    ...
    {
        ServerPlayerBase var7 = this.playerAPI.GetOverwrittenKnockBack(this);
    ...
    {
        ServerPlayerBase var2 = this.playerAPI.GetOverwrittenOnStruckByLightning(this);
    ...
    {
        ServerPlayerBase var1 = this.playerAPI.GetOverwrittenSwingItem(this);
