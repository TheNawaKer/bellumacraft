...
{	
		...
		{	
		    ...
		    //ModLoader.addSpawn(EntityCheval.class, 12, 4, 4,EnumCreatureType.creature,new BiomeGenBase[] {BiomeGenBase.desert,  BiomeGenBase.beach, BiomeGenBase.plains, BiomeGenBase.forest }); // nombre de mobs spawn�s et choix des biomes pour le spawn 
