...
public class EntityMagicArrow extends Entity implements IProjectile
{
    ...
    public EntityMagicArrow(World par1World, EntityLiving par2EntityLiving, EntityLiving par3EntityLiving, float par4, float par5)
    {
        super(par1World);
        this.renderDistanceWeight = 10.0D;
    ...
    public EntityMagicArrow(World par1World, EntityLiving par2EntityLiving, float par3)
    {
        super(par1World);
        this.renderDistanceWeight = 10.0D;
        this.shootingEntity = par2EntityLiving;
     ...
     */
    public static DamageSource causeArrowDamage(EntityMagicArrow entityMagicArrow, Entity par1Entity)
    {
        return (new EntityDamageSourceIndirect("arrow", entityMagicArrow, par1Entity)).setProjectile();
    }
