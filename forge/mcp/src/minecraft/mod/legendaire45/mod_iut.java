...
{	
		...
		{	
			...
			LanguageRegistry.addName(ArmorE3, "Jambi�re en Emeraude");
			...
			LanguageRegistry.addName(ArmorS3, "Jambi�re en Saphir");
			...
			LanguageRegistry.addName(ArmorR3, "Jambi�re en Ruby");
